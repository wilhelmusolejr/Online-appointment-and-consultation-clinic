...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <div class="iocn-link">
          <a href="../admin2/appointment/pending.php">
        ...
        <ul class="sub-menu">
          ...
          <li><a href="../admin2/appointment/pending.php">Pending Appointment</a></li>
          <li><a href="../admin2/appointment/approved.php">Approved Appointment</a></li>
        </ul>
      </li>
      <hr class="line">
