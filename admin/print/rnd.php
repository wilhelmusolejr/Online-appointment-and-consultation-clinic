...
require_once $path."../classes/user.class.php";
    ...
    if(isset($_GET['user_id'])) {
      ...
      $profileImg = $userData['profile_img'] != null ? $userData['profile_img'] : "dummy_user.jpg";

      $age = calculate_age(explode("-", $userData['birthdate'])[0])." years old.";
    } 
...
<head>
  ...
  <script src="rnd.js" defer></script>

  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" defer></script>
  <title>RND Information for <?php echo $userData['first_name']." ".$userData['last_name'] ?></title>
</head>
...
<body>
  ...
  <section class="print-parent">
    ...
    <div class="client-pic-parent">
      <img class="client-pic" src="<?php echo $path."../uploads/".$profileImg ?>" alt="">
    </div>
    ...
    <div class="client-info-parent">
      ...
      <div class="divider">
        ...
        <div class="right">
          <p><?php echo $userData['gender'] == 1? "Male" : "Female" ?></p>
        </div>
      </div>
    ...
    <p>Total on progress appointment: <span class="progress-appointment">LOADING</span></p>
