                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach ($_SESSION['table10'] as $key => $value){ //start of loop
                        ?>
                            <tr>
                               <!-- always use echo to output PHP values -->
                                <td><?php echo_safe($value['image']); ?></td>
                                <td><?php echo_safe($value['email_address']); ?></td>
                                <td><?php echo_safe($value['id_img']); ?></td>
                                <td class="action">
                                    <a class="action-approve" href="#<?php echo($key);?>">APPROVED</a>
                                    <a class="action-decline" href="#<?php echo($key);?>">DECLINE</a>
                                </td>
                            </tr>
                        <?php
                            $i++;
