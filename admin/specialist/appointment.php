...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <div class="iocn-link">
          <a href="../specialist/appointment.php"  class="active">
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="../specialist/appointment.php"  class="active">Specialist</a></li>
          <li><a href="personal.php">Personal Information</a></li>
          <li><a href="appointment.php" class="active">Appointment Information</a></li>
